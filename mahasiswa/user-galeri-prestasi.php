...
$sql = "SELECT * FROM beritaprestasi ORDER BY upload_date DESC LIMIT 8";
...
<head>
  <meta charset="utf-8" />
  <title> PRESMA Vokasi - Galeri Prestasi</title>
      ...
      <div class="row g-4">
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<a class='btn btn-rectangle mx-1' href='user-detail-pres-1.php?id=" . $row['id_berita'] . "'>";
            echo "<h5 class='text-center my-2 text-white'>Selengkapnya</h5>";
            echo "</a>";
            echo "</div>";
            echo "</div>";
            echo "<div class='text-center p-4'>";
            echo "<p>" . $row['judul_berita'] . "</p>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
          }
