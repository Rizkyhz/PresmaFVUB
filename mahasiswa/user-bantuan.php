...
<head>
  <meta charset="utf-8" />
  <title> PRESMA Vokasi - Panduan</title>
  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        <a href="index-user-user.php" class="nav-item nav-link active">Home</a>
      ...
      <a href="../../index.php" class="btn py-4 px-lg-5 d-none d-lg-block" style="background-color: #003366; color: #ff9900">Logout<i class="fa fa-arrow-right ms-3" style="color: #ff9900"></i></a>
    </div>
  </nav>
  <!-- Navbar End -->
  ...
  <div class="container-xxl py-5">
    <div class="container">
      <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="mb-5">PRESMA Vokasi</h1>
      </div>
      <!-- isi tabel -->
      <div class="card text-white" style="background-color: #003366; border-radius: 10px">
        <div class="card-header">Buku Panduan</div>
        <dif class="d-flex flex-wrap">
          <div class="card-body">
            <!-- Tautan Unduh PDF -->
            <a href="buku panduan/BUKU PANDUAN PRESMA.pdf" class="btn btn-light" download>Unduh Buku Panduan (PDF)</a>
          </div>
        </dif>
      </div>
    </div>
